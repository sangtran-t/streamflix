    ...
    >
      ...
      <div
        style={{
          ...
          zIndex: 0,
          background:
            'linear-gradient(180deg, transparent 0%, rgba(22,23,27,0.4) 50%, var(--bg) 100%)',
          pointerEvents: 'none',
        }}
      />
          ...
          <Reveal style={{ flex: '0 0 280px', maxWidth: 300 }}>
            <div>
              ...
              <div style={{ marginBottom: 32 }}>
                <h3
                  style={{ fontSize: 14, fontWeight: 700, marginBottom: 12, color: 'var(--text)' }}
                >
                  Synopsis
                </h3>
                {title.synopsis ? (
                  <p style={{ fontSize: 14, lineHeight: 1.6, color: 'var(--text-faint)' }}>
                    {title.synopsis}
                  </p>
                ) : (
                  <p style={{ fontSize: 14, color: 'var(--text-ghost)', fontStyle: 'italic' }}>
          ...
          <Reveal delay={120} style={{ flex: '1 1 0%', minWidth: 0 }}>
            <div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
                  ...
                  <div style={{ display: 'flex', gap: 4 }}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 11, fontWeight: 600 }}>Favorite</span>
                    </button>
                    <button
                      className="btn btn--ghost"
                      style={{
                ...
                >
                  <Icon name="star" size={14} style={{ color: 'var(--accent)' }} /> 0.0{' '}
                  <span style={{ fontWeight: 400, opacity: 0.8 }}>Rating</span>
                </div>
              </div>
